...
<div class="leftnav">
  ...
  <ul style="display:block">
   <!-- <li><a href="/Webphp/index.php/Teacher/teacoulist.html" target="right"><span class="icon-caret-right"></span>我的课表</a></li>-->
   <li><a href="/Webphp/index.php/Teacher/todayCourseTea.html" target="right"><span class="icon-caret-right"></span>今日课程</a></li>
    <li><a href="/Webphp/index.php/Teacher/modify.html" target="right"><span class="icon-caret-right"></span>修改密码</a></li>
    ...
    <li><a href="/Webphp/index.php/Teacher/teaTimeset.html" target="right"><span class="icon-caret-right"></span>教师上课信息查询</a></li>   
  ...
  <ul>
    ...
    <li><a href="cate.html" target="right"><span class="icon-caret-right"></span>分类管理</a></li>  -->
         <li><a target="right"><span class="icon-caret-right"></span>工号: <?php echo (session('TeatNo')); ?></a></li>
         <li><a target="right"><span class="icon-caret-right"></span>姓名: <?php echo (session('TeaName')); ?></a></li>
         <li><a target="right"><span class="icon-caret-right"></span>身份: 教师</a></li>     
  </ul>  
</div>
...
<div class="admin">
  <iframe scrolling="auto" rameborder="0" src="/Webphp/index.php/Teacher/todayCourseTea.html" name="right" width="100%" height="100%"></iframe>
