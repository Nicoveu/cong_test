...
<div class="panel admin-panel">
   <h3 align="center"><font size="4">查询教师课程信息&emsp;&emsp;&emsp;</font></h3>
    <hr color="#FFCC66">
  <form action=<?php echo U('/Manager/queryTeacher');?> method="post" align="center">
  <p>
   <font size="4">请输入教师姓名:</font>
...
<form action=<?php echo U('/Manager/queryTeacher');?> method="post">
   <!-- <select name="test">
...
//document.getElementsByTagName("button")[0].onclick = clickHandler; 
   ...
   <!-- <button class="button bg-main icon-check-square-o" type="submit" value="确定" name="ok" 
value="Display alert box"> 提交</button>
    <button class="button bg-main icon-check-square-o" type="reset" value="重置" name="ok" 
value="Display alert box"> 重置</button>-->
