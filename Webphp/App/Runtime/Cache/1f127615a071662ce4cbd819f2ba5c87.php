...
<div class="panel admin-panel">
   <h3 align="center"><font size="4">查询学生课程信息&emsp;&emsp;&emsp;</font></h3>
    <hr color="#FFCC66">
  <form action=<?php echo U('/Manager/queryStudent');?> method="post" align="center">
  <p>
   <font size="4">请输入学生姓名:</font>
...
<form action=<?php echo U('/Manager/queryStudent');?> method="post">
   <!-- <select name="test">
