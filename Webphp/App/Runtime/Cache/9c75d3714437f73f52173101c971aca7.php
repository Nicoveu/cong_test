...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action=<?php echo U('/Manager/modifyDoit');?>>
      <div class="form-group">
        ...
        <div class="field">
          ...
          <ul>
          <li><a target="right"><?php echo (session('no')); ?></a></li>
           <ul>
          </label>
        </div>
      </div> 
       <form action=<?php echo U('/Manager/modifyDoit');?> method="post">    
      <div class="form-group">
        <div class="label">
