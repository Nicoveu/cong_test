<?php if (!defined('THINK_PATH')) exit(); date_default_timezone_set("PRC"); $nowtime = time(); $rq = date("Y-m-d",$nowtime); ?>
<!doctype html>
<html>
...
<div id="all" >
    ...
    <div class="style1">学生课程查询系统</div>
		...
		<div id="top"><a style="text-decoration:none" href="<?php echo U('Index/index');?>">学校主页</a>
...
<div class="box">
        	<h3>学生页面</h3>
               <ul>用户信息
			     <li>学号: <?php echo (session('StuNo')); ?></li>
