...
<div class="panel admin-panel">
   <h3 align="center"><font size="4">空闲教室查询及教室课程查询&emsp;&emsp;</font></h3>
    <hr color="#FFCC66">
  <form action=<?php echo U('/Student/getEmptyRooms');?> method="post" align="center">
  <p>
   <font size="4">请输入教室号:</font>
...
<form action=<?php echo U('/Student/getEmptyRooms');?> method="post">
   <!-- <select name="test">
