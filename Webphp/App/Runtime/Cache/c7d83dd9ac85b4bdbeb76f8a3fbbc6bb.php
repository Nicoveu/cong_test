...
<div class="panel admin-panel">
   <h3 align="center"><font size="4">班级课程查询&emsp;&emsp;</font></h3>
    <hr color="#FFCC66">
  <form action=<?php echo U('/Manager/queryClass');?> method="post" align="center">
  <p>
   <font size="4">请输入班级名:</font>
...
<form action=<?php echo U('/Manager/queryClass');?> method="post">
   <!-- <select name="test">
