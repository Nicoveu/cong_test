...
<div class="panel admin-panel">
  ...
  &nbsp;&emsp;&emsp;
  <div align="center"><button class="button bg-main icon-check-square-o" type="submit" value="确定" name="ok" onclick="display_alert()" value="Display alert box"><a href="/Webphp/index.php/Manager/addcouInfo.html">添加课程信息</a></button> 
  <button class="button bg-main icon-check-square-o" type="submit" value="确定" name="ok" onclick="display_alert()" value="Display alert box"><a href="/Webphp/index.php/Manager/addMulcouInfo.html">添加多门课程信息</a></button> </div>
  <font size="2">
  ...
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
    ...
    <td align="center"><?php echo ($vo["classes"]); ?></td>
    <td align="center"><?php echo ($vo["content"]); ?></td>
    <td><a href="<?php echo U("/Manager/modifycouInfo/date/$vo[date]/session/$vo[session]/classes/$vo[classes]");?>">修改</a> / <a href="<?php echo U("/Manager/delete/date/$vo[date]/session/$vo[session]/classes/$vo[classes]");?>" onclick="return confirm('确定删除?')">删除</a></td>
   <!--
